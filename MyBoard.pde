//Battleship game, Final assignment, 2017, Hiro Ayettey & Theodore Wang
/* The board
...
void setup() {
  ...
  default:
    {
      //Makes the board and places the boats after a difficulty is selected
      int w = width / cols;
...
void computerTurn() {
  switch(gameState) {
    ...
    case(mediumGame):
    {
      //Uses another function(at the bottom) to determine where to hit
